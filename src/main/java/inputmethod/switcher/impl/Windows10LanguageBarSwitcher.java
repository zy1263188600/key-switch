...
public class Windows10LanguageBarSwitcher implements InputMethodSwitchStrategy {

    private static final Logger LOG = Logger.getInstance(Windows10LanguageBarSwitcher.class);
...
//        );
        PointerByReference buttonCondition = automation.createTrueCondition();
