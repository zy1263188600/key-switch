...
public class Windows10UIAutomationSwitcher implements InputMethodSwitchStrategy {

    private static final Logger LOG = Logger.getInstance(Windows10UIAutomationSwitcher.class);
